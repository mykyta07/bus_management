...
class Ui_busesDialog(object):
    def setupUi(self, busesDialog):
        ...
        self.pushButton.setGeometry(QRect(200, 330, 121, 41))
...
"border-radius:\"10px\"")
        ...
        self.pushButton_2.setGeometry(QRect(330, 330, 121, 41))
...
"border-radius:\"10px\"")
        ...
        self.dateEdit.setDateTime(QDateTime(QDate(today_date.addDays(10)), QTime(0, 0, 0)))
